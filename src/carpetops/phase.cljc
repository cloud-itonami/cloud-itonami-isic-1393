(ns carpetops.phase
  "Phase 0->3 staged rollout for the carpet/rug-plant operations
  coordination actor.
  ...
  consequence (a tufting-machine, weaving-loom, or backing-line
  ...
  `carpetops.governor`'s `line-operate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Carpet & Rug Plant Operations Governor verdict to a base
