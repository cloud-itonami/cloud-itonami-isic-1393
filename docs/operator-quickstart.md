# Operator Quickstart — Manufacture of carpets and rugs

Shortest path from clone to a verified local dry-run for **ISIC 1393** (`cloud-itonami-isic-1393`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1393.git
cd cloud-itonami-isic-1393
```
...
- Blueprint governor key: `carpet-rug-plant-operations-governor`
- Likely source path: `carpetops.governor.cljc`
