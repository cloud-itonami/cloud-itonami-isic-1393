# Business Model: Manufacture of carpets and rugs
...
## Classification
- Repository: `cloud-itonami-isic-1393` ([github.com/cloud-itonami/cloud-itonami-isic-1393](https://github.com/cloud-itonami/cloud-itonami-isic-1393))
- ISIC Rev.5: `1393` — Manufacture of carpets and rugs
- Domain: `:textiles/carpets-rugs`
- Social impact: :worker-safety :labor-standards :materials-traceability
- Actor: `:carpet-rug-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :textiles/carpets-rugs — who wants
...
One managed tenant (:textiles/carpets-rugs):
...
- Do not bypass the `:carpet-rug-plant-operations-governor` for production decisions.
